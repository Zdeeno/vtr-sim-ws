...
tmux send-keys -t simulator:simulator "source ws/devel/setup.bash" Enter
...
tmux send-keys -t simulator:control "source ws/devel/setup.bash" Enter
...
tmux send-keys -t simulator:simulation "source ws/devel/setup.bash" Enter
tmux send-keys -t simulator:simulation "sleep 10" Enter
tmux send-keys -t simulator:simulation "python ws/src/navigation_unity_core/scripts/gym_train_td3.py"
